...
// Updates the selected element's content to current date with the help toLocaleDateString() method to format it using "en-US" format and dateOptions for the value format. 
...
const options = {
	method: 'POST',
	headers: {
		'x-rapidapi-key': 'c13c138a09msh0fbc8b884b04278p12446bjsn7b8220db8829',
...
.then(data => {
	...
	// for loop - used for repeatable task
				// index < 25 ( from index 0 to index 24 )
